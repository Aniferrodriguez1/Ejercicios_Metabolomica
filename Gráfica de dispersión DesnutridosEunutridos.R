...
#¿Qué miRNAs fueron los que más cambiaron entre los animales 
#desnutridos (tratamiento) comparados con los animales eunutridos (control)?

#Los datos que más cambiaron serían aquellos en el Dataframe top_10
#estos representan la media de la expresión en el grupo control
#aunque típicamente se buscaría la comparación directa entre tratamiento
#y control para determinar el cambio 

#En este caso se visualizan en la gráfica estos miRNAs en la gráfica
#de dispersión 3 donde los puntos más relevantes se encuentran etiquetados. 
